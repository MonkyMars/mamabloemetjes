...
export const mockProducts: Product[] = [
  createMockProduct(
    ...
    'Luxe Vilt Roos Boeket',
    89.99,
    'Luxueuze dieprode rozen handgemaakt van vilt',
    'bouquet',
    'large',
    ['red', 'pink'],
  ),
  createMockProduct(
    ...
    'Rode Vilt Roos',
    12.99,
    'Enkele handgemaakte rode roos van premium vilt',
    'flower',
    'medium',
    ['red'],
  ),
  ...
  createMockProduct(
    ...
    'Roze Vilt Tulp',
    8.99,
    'Enkele handgemaakte tulp in zacht roze vilt',
    'flower',
    'small',
    ['pink'],
  ),
  ...
  createMockProduct(
    ...
    'Witte Vilt Lelie',
    15.99,
    'Enkele witte lelie van hoogwaardig vilt materiaal',
    'flower',
    'large',
    ['white'],
  ),
